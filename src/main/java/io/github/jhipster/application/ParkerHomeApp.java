...
public class ParkerHomeApp {

    private static final Logger log = LoggerFactory.getLogger(ParkerHomeApp.class);

    private final Environment env;

    public ParkerHomeApp(Environment env) {
        this.env = env;
    }

    /**
     * Initializes ParkerHome.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(ParkerHomeApp.class);
